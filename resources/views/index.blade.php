	 ...
	 <div class="modal-content">
         <div class="modal-header"> 
          ...
          <div class="modal-body">
            <form method="post" action="/user/register" name="login_form">
              <p><input type="email" class="span3" name="email" id="email" placeholder="Email"></p>
            ...
            <div class="row">
				...
				@foreach($result as $r)
                            <div class="single-product">
                                ...
                                <h2><a href="/product/{{ $r->product_id }}">{{ $r->name }}</a></h2>
				...
				<div class="btn-group wishlist">
						<button type="button" class="btn btn-danger" onClick="getMessage('{{$r->product_id}}');">
							Add to wishlist 
						</button>
					</div>
			<div class="btn-group wishlist">
					
				@include('components.share', ['url' => 'http://localhost:8000/product'.$r->product_id])
                ...
                <div class="col-md-4">
                    ...
                    <div class="single-product-widget">
                        ...
                        <div class="single-wid-product">
                            ...
                            <a href="#"><img src="{{ ('asset/img/product-thumb-2.jpg') }}" alt="" class="product-thumb"></a>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="copyright">
                        ...
                        <p>&copy; 2015 uCommerce. All Rights Reserved. <a href="https://www.appliancesdelivered.ie/" target="_blank">Appliancesdelivered</a></p>
